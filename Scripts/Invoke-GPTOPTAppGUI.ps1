...
$Window.FindName('SafetyBtn').Add_Click({ Add-Log 'Running safety scan...'; $SafetyBox.Text = Run-Mode 'safety' (CurrentContext); Add-Log 'Safety scan complete.' })
$Window.FindName('RunSafetyBtn').Add_Click({ Add-Log 'Running safety scan...'; $SafetyBox.Text = Run-Mode 'safety' (CurrentContext); Add-Log 'Safety scan complete.' })
